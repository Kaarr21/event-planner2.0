...
<div>
    <div class="fixed inset-0 bg-[#101722] grayscale-[0.5] brightness-[0.2]"
    ...
    <div class="relative flex min-h-screen w-full flex-col">
        <header
            class="flex items-center justify-between whitespace-nowrap border-b border-white/10 px-6 py-4 lg:px-20 text-white">
        ...
        <main class="flex-1 flex items-center justify-center p-6">
            <div
                class="glass-card w-full max-w-[480px] rounded-xl p-8 lg:p-12 shadow-2xl bg-[#101722]/75 backdrop-blur-[20px] border border-[#257bf4]/20 text-white">
                <div class="flex flex-col items-center text-center mb-10">
                    <div
                        class="size-16 rounded-full bg-[#257bf4]/20 flex items-center justify-center mb-6 border border-[#257bf4]/30">
                    ...
                    <p class="text-slate-400 text-base leading-relaxed">
                        Security first. We've sent a 6-digit code to <br class="hidden sm:block" /> <span
                            class="text-slate-200 font-medium italic">{{ $email }}</span>
                    </p>
                </div>
                ...
                <form wire:submit="verify" class="flex flex-col gap-8">
                    <div>
                        <input wire:model="code"
                            class="w-full h-16 text-center text-4xl font-bold bg-white/5 border border-white/10 rounded-xl focus:border-[#257bf4] focus:ring-2 focus:ring-[#257bf4]/20 focus:outline-none transition-all text-white tracking-[0.5em] placeholder:tracking-normal"
                            placeholder="000000" maxlength="6" type="text" required autofocus />
                    ...
                    <div class="flex flex-col gap-4">
                        <button
                            class="w-full h-14 bg-[#257bf4] hover:bg-[#257bf4]/90 text-white font-bold text-lg rounded-xl shadow-lg shadow-[#257bf4]/20 flex items-center justify-center transition-all group"
                            type="submit">
                        ...
                        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 mt-2">
                            <button type="button" wire:click="resend"
                                class="text-slate-400 hover:text-[#257bf4] text-sm font-medium flex items-center gap-1 transition-colors">
                                <span class="material-symbols-outlined text-lg">refresh</span>
                                <span wire:loading.remove wire:target="resend">Resend Code</span>
                                <span wire:loading wire:target="resend">Sending...</span>
                            </button>
                            <a class="text-slate-400 hover:text-white text-sm font-medium flex items-center gap-1 transition-colors"
                ...
                <div
                    class="mt-12 flex items-center justify-center gap-2 text-slate-500 text-xs uppercase tracking-widest">
