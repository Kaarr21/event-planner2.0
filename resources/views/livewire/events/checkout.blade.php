    ...
    public function completePurchase()
    {
        ...
        try {
            ...
            $order = Order::create([
                ...
                'payment_method' => 'none', // Free or direct for individual
            ]);
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div class="space-y-6 lg:sticky lg:top-8">
                ...
                <div class="px-8 py-6 bg-white/5 rounded-[2rem] border border-white/5 flex flex-col gap-4">
                    ...
                    <div class="flex items-center gap-4">
                        <span class="w-6 h-6 rounded-full bg-brand-orange flex items-center justify-center text-[10px] font-black text-white">2</span>
