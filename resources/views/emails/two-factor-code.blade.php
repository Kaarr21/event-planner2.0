...
<head>
    ...
    <style>
        ...
        .header { background-color: #257bf4; padding: 24px; text-align: center; }
        .header h1 { margin: 0; color: #ffffff; font-size: 24px; font-weight: bold; }
        .content { padding: 32px 24px; text-align: center; }
        .content p { margin: 0 0 16px; color: #3f3f46; font-size: 16px; line-height: 1.5; }
        .code-box { background-color: #f1f5f9; border: 1px solid #e2e8f0; border-radius: 6px; padding: 16px; margin: 24px 0; font-size: 32px; font-weight: bold; color: #0f172a; letter-spacing: 0.25em; text-align: center; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Please use the following 6-digit code to complete your sign-in process. This code will expire in 10 minutes.</p>
            <div class="code-box">
                {{ $code }}
            </div>
